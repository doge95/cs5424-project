...
def get_stock_level_transaction(s, w_id, d_id, t, l):
    ...
    count_items = data_cursor.fetchall()
...
def get_popular_items_transaction(i, w_id, d_id, l):
    ...
    get_all_items_per_selected_order_query = "select ol_i_id, COUNT( DISTINCT ol_o_id)/{} " \
                                             "from order_line where ol_w_id={} and ol_d_id={} and ol_o_id in {} and ol_i_id in {} " \
                                             "group by ol_i_id;".format(l, w_id, d_id, in_scope_o_ids, unique_popular_item_ids)
